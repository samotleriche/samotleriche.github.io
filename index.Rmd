...
<span style="color:green;font-family: 'Times'; font-size: 20px;"> **I**</span> graduated from the [University of Puget Sound](https://www.pugetsound.edu/) with a BSc in Molecular and Cellular Biology in 2014. Afterwards, I worked in the medical field as an EMT-B before returned to my home state to begin working toward my MSc in [Information Systems and Assurance](https://msisa.mgt.unm.edu/default.asp?dd=masters). I worked as a Graduate Research Assistant until graduating in Dec. 2018. My concentrations during my master's were databases and data analysis.
